...
export default function Viper({ posts }) {
  return (
    <>
        <div className="max-w-6xl w-100% grid grid-cols-4 mx-auto mt-10">
          {posts.map((post, index) => {
            const { date, title, image, post: link, tags, diff } = post.meta;
            return (
              ...
              >
                ...
                <div className="w-full mt-3 flex max-w-full justify-start items-start">
                    <Image
                      quality={100}
                      src={`/viper.png`}
                      alt="viper picture"
